...
void introScreen()
{
	...
	displayRasterText(-100, 150, 0.0,"created as");
		glColor3f(1.0, 1.0, 1.0);
	 displayRasterText(-130, 80, 0.0,"Computer Graphics Lab Project");
	 	glColor3f(1.0, 0.0, 0.0);
	  displayRasterText(-800, -100, 0.0," STUDENT NAMES");
	  	glColor3f(1.0, 1.0, 1.0);
	displayRasterText(-800, -200, 0.0," Parijaat Gaur");
	displayRasterText(-800, -285, 0.0," Rachit Sinha");
		glColor3f(1.0, 0.0, 0.0);
	displayRasterText(500, -100, 0.0,"Under the Guidance of");
		glColor3f(1.0, 1.0, 1.0);
	displayRasterText(500, -200, 0.0,"Mr.Kuntal Chowdhary");
		glColor3f(1.0, 0.0, 0.0);
	displayRasterText(-250, -400, 0.0,"3P34 (3CS14)");
        glColor3f(1.0, 1.0, 1.0);
